...
excerpt: "Let’s discuss the five practical Ruby on Rails projects you’ll ever be tasked to build, the stack you could use plus gems you could use to speed up your development process."
author: rkcudjoe
